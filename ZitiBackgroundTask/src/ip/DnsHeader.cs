...
namespace NetFoundry.VPN.IP
{
    ...
    internal sealed class DnsHeader
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("DNS");
            System.Diagnostics.Debug.WriteLine("    Identification: " + Identification);
            System.Diagnostics.Debug.WriteLine("    Flags: " + Flags);
            System.Diagnostics.Debug.WriteLine("    Questions: " + TotalQuestions);
            System.Diagnostics.Debug.WriteLine("    Answer RRs: " + TotalAnswerRRs);
            System.Diagnostics.Debug.WriteLine("    Authority RRs: " + TotalAuthorityRRs);
            System.Diagnostics.Debug.WriteLine("    Additional RRs: " + TotalAdditionalRRs);
        }
        ...
        public DnsHeader([System.Runtime.InteropServices.WindowsRuntime.ReadOnlyArray()] byte[]byBuffer, int nReceived)
        {
