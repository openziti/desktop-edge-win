...
public class QuickstartFixture : IAsyncLifetime {
	...
	private static readonly string[] TestIdentityNames = { "normal-user-01", "normal-user-02", "normal-user-03", "normal-user-04", "normal-user-05", "normal-user-06", "normal-user-07" };
	...
	private void StartQuickstart() {
		...
		if (portAlreadyInUse) {
			throw new InvalidOperationException($"controller port {ControllerPort} is already in use. Check for a stale ziti quickstart instance from a prior run and kill it before retrying.");
		}
