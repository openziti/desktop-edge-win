...
* [Issue 1028](https://github.com/openziti/desktop-edge-win/issues/1028) - Adding an identity by URL brings the UI forward when it's provisioned, and starts MFA setup if the identity requires it
