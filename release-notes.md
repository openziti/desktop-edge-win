...
* Fixed issue intercepting connections when the configured IP is not exactly in 100.64.0.0/10
* Print a warning when the configured IP is not in the carrier grade NAT range 100.64.0.0/10
